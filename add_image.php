...
if(isset($_POST['submit'])){
    ...
    $koneksi->query("INSERT INTO cat(name, file_path)VALUES('$name', '$newName')");
    $location = 'assets/images/'.$newName;
    move_uploaded_file($tmp, $location);

    echo "<script>alert('Data berhasil ditambahkan');window.location.replace('add_image.php');</script>";
}
?>